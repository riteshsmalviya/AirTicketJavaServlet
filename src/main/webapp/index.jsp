...
animate-bounce">Home</a>
	...
	<section class="text-gray-600 body-font overflow-hidden">
		<div class="container px-5 px-5 pt-24 pb-4 mx-auto">
			<div
				class="flex flex-col text-center w-full mb-20 p-2 rounded-lg text-gray-900">
				<h1 class="text-6xl font-bold title-font mb-4 ">Ritesh
					Rohit Global Travels</h1>
				<p class="lg:w-2/3 mx-auto leading-relaxed text-xl">Wow, Ritesh
					Rohit Global Travels sounds like an amazing travel company! I mean,
					why bother with real-world experience or knowledge when you can
					just create a company for a college project, right? I'm sure your
					imaginary customers will be lining up around the block to book
					their airplane, bus, and train tickets with your company that has
					no actual connections or partnerships with any of those industries.
					And the fact that you can offer travel to "anywhere in the world"
					without any actual infrastructure or logistics in place is truly
					impressive. Who needs actual expertise or experience in the field
					of travel when you have a name like that?</p>
			</div>
	</section>
	<section class="text-gray-600 body-font">
		<div class="container px-5 py-4 mx-auto">
			<div class="flex flex-col text-center w-full mb-20">
				<div class="flex flex-wrap items-center justify-center">
					<h1 class=" text-6xl font-bold title-font mb-4 p-2">Book
						Your    </h1>
       ...
       <path style="fill:#D7D5D9;"
								d="M294.466,368.409l-113.285,97.066l-17.511,15.003l-9.922-11.581 c-8.07-9.418-22.247-10.512-31.665-2.441l-7.438,6.372L85.061,438.3l7.438-6.372c9.418-8.07,10.512-22.247,2.441-31.665l0,0 c-8.07-9.418-22.247-10.512-31.665-2.441l-7.438,6.372l-29.585-34.529l13.577-10.767L215.174,145.61l115.535-98.995l17.618-15.095 l9.922,11.581c8.07,9.418,22.247,10.512,31.665,2.441l7.438-6.372l29.585,34.529l-7.438,6.372 c-9.418,8.07-10.512,22.247-2.441,31.665l0,0c8.07,9.418,22.247,10.512,31.665,2.441l7.438-6.372l29.585,34.529L472.17,154.77 L294.466,368.409z"></path> <path
								style="fill:#77757E;"
								d="M345.666,366.389H63.03h-23.2v-15.25c0-12.402-10.054-22.457-22.457-22.457H7.579v-45.47h9.794 c12.402,0,22.457-10.054,22.457-22.457l0,0c0-12.402-10.054-22.457-22.457-22.457H7.579v-45.47h9.794 c12.402,0,22.457-10.054,22.457-22.457V145.61h23.2h70.872h56.835H448.97h23.2v15.25c0,12.402,10.054,22.457,22.457,22.457h9.794 v45.47h-9.794c-12.402,0-22.457,10.054-22.457,22.457l0,0c0,12.402,10.054,22.457,22.457,22.457h9.794v45.47h-9.794 c-12.402,0-22.457,10.054-22.457,22.457v24.761h-23.2h-36.783H345.666z"></path> <polygon
								style="fill:#FFDA44;"
								points="212.007,181.141 427.898,181.141 427.898,330.859 84.102,330.859 84.102,181.141 154.083,181.141 "></polygon> <path
								d="M156.673,222.827c2.771,0,4.057,2.969,4.057,5.739c0,3.067-1.484,5.838-4.057,5.838h-14.446v56.696 c0,2.672-3.265,4.057-6.432,4.057c-3.264,0-6.431-1.385-6.431-4.057v-56.696h-14.546c-2.573,0-4.057-2.672-4.057-5.838 c0-2.77,1.286-5.739,4.057-5.739L156.673,222.827L156.673,222.827z"></path> <path
								d="M167.755,226.784c0-2.77,3.166-3.957,6.431-3.957c3.167,0,6.431,1.187,6.431,3.957V291.1c0,2.672-3.264,4.057-6.431,4.057 c-3.265,0-6.431-1.385-6.431-4.057V226.784z"></path> <path
								d="M215.052,234.106c-6.63,0-10.389,3.661-10.389,11.38v27.606c0,7.717,3.76,11.379,10.587,11.379 c9.004,0,9.795-6.431,10.092-10.587c0.198-3.067,2.969-4.057,6.333-4.057c4.452,0,6.531,1.285,6.531,6.333 c0,11.973-9.796,19.592-23.649,19.592c-12.467,0-22.758-6.135-22.758-22.659v-27.606c0-16.525,10.389-22.659,22.856-22.659 c13.753,0,23.55,7.321,23.55,18.8c0,5.146-2.079,6.333-6.432,6.333c-3.66,0-6.333-1.088-6.431-4.057 C225.144,240.835,224.451,234.106,215.052,234.106z"></path> <path
								d="M246.909,226.784c0-2.77,3.166-3.957,6.431-3.957c3.167,0,6.431,1.187,6.431,3.957v27.013l21.373-29.09 c0.989-1.385,2.177-1.88,3.561-1.88c3.265,0,7.421,3.364,7.421,6.63c0,0.692-0.099,1.582-0.791,2.473l-17.711,22.165l21.571,32.85 c0.494,0.693,0.692,1.484,0.692,2.276c0,3.167-3.957,6.431-7.717,6.431c-1.683,0-3.364-0.693-4.452-2.473l-18.602-28.2l-5.344,6.728 V291.1c0,2.672-3.264,4.057-6.431,4.057c-3.265,0-6.431-1.385-6.431-4.057v-64.316H246.909z"></path> <path
								d="M314.387,253.896h15.041c2.573,0,4.057,2.474,4.057,5.146c0,2.276-1.286,4.948-4.057,4.948h-15.041v19.889h28.003 c2.573,0,4.057,2.672,4.057,5.739c0,2.672-1.286,5.541-4.057,5.541h-35.225c-2.87,0-5.64-1.385-5.64-4.057v-64.216 c0-2.672,2.77-4.057,5.64-4.057h35.225c2.77,0,4.057,2.87,4.057,5.541c0,3.067-1.484,5.739-4.057,5.739h-28.003V253.896z"></path> <path
								d="M395.127,222.827c2.771,0,4.057,2.969,4.057,5.739c0,3.067-1.484,5.838-4.057,5.838h-14.446v56.696 c0,2.672-3.265,4.057-6.432,4.057c-3.264,0-6.431-1.385-6.431-4.057v-56.696h-14.546c-2.573,0-4.057-2.672-4.057-5.838 c0-2.77,1.286-5.739,4.057-5.739L395.127,222.827L395.127,222.827z"></path> <g
								style="opacity:0.19;"> <path style="fill:#3E3B43;"
